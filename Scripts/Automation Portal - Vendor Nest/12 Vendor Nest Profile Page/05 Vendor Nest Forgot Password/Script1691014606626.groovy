...
WebUI.click(findTestObject('Object Repository/Page_ListReports  Edit Profile/a_Forgot Password'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Edit Profile/span_Thanks An email has been sent to mn.fl_5bd00f'), 
    0)

WebUI.delay(3)

WebUI.click(findTestObject('Page_ListReports  Edit Profile/button_Ok_changePass'))
