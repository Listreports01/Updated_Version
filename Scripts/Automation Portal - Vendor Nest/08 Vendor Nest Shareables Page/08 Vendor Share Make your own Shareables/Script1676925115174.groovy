...
WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Shareables/h3_Want to add some text'), 0)

WebUI.setText(findTestObject('Object Repository/Page_ListReports  Shareables/textarea_Want to add some text_MuiBox-root jss835'), 
    'Test')

WebUI.delay(5)

WebUI.click(findTestObject('Page_ListReports  Shareables/div_Share - MYO'))
...
WebUI.click(findTestObject('Page_ListReports  Shareables/a_Share_MYO'))

WebUI.switchToWindowUrl('https://www.facebook.com/login.php?skip_api_login=1&api_key=966242223397117&signed_next=1&next=https%3A%2F%2Fwww.facebook.com%2Fsharer.php%3Fu%3Dhttps%253A%252F%252Flstrep.co%252FPHptykq-h&cancel_url=https%3A%2F%2Fwww.facebook.com%2Fdialog%2Fclose_window%2F%3Fapp_id%3D966242223397117%26connect%3D0%23_%3D_&display=popup&locale=en_US')
