...
WebUI.click(findTestObject('Object Repository/Page_ListReports  Shareables/span_Notify me when data is available'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Shareables/h2_Thanks'), 0)

WebUI.delay(3)

WebUI.click(findTestObject('Object Repository/Page_ListReports  Shareables/span_Ok'))
