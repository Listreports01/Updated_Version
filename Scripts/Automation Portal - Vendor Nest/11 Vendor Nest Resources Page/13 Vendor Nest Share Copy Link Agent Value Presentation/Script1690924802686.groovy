...
WebUI.click(findTestObject('Page_ListReports  Agent education tools/div_Share1'))

WebUI.delay(2)

WebUI.click(findTestObject('Page_ListReports  Agent education tools/button_Copy Link1'))
