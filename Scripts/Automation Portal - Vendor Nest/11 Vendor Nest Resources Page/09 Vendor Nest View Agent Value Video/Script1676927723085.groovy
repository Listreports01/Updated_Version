...
WebUI.click(findTestObject('Page_ListReports  Agent education tools/div_View'))

WebUI.switchToWindowTitle('')

WebUI.navigateToUrl('https://listreports.wistia.com/medias/u3n951yoyu')

WebUI.click(findTestObject('Object Repository/Page_ListReports for Agents/div'))

WebUI.delay(10)

WebUI.click(findTestObject('Object Repository/Page_ListReports for Agents/div_Click for sound_w-vulcan--background w-_e2a7a2'))
