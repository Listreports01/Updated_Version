...
WebUI.setText(findTestObject('Object Repository/Page_ListReports  My Agents/input_Follow Agent_MuiBox-root jss530 sc-ib_f2097f'), 
    'Marbz')
...
WebUI.click(findTestObject('Page_ListReports  My Agents/button_Ok_follow'))
