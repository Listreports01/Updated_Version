...
WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  My Agents/th_Agent'), 0)

WebUI.click(findTestObject('Object Repository/Page_ListReports  My Agents/span_View'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Agent Details/div_Back to My Agents'), 0)

WebUI.delay(5)

WebUI.click(findTestObject('Object Repository/Page_ListReports  Agent Details/span_Following'))
