...
WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  My Agents/span_Invite Agent'), 0)
...
WebUI.click(findTestObject('Object Repository/Page_ListReports  My Agents/button_Send test to self'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  My Agents/h2_Thanks'), 0)
