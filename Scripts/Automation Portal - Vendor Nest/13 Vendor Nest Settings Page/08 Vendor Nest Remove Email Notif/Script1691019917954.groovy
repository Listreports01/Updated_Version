...
WebUI.click(findTestObject('Object Repository/Page_ListReports  Settings/div_Remove Email Notif'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Settings/span_Alias removed successfully'), 
    0)

WebUI.delay(3)

WebUI.click(findTestObject('Page_ListReports  Settings/button_Ok_Notif'))
